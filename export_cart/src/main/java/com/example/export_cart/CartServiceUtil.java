...
public class CartServiceUtil {
    ...
    public static ICartService getService() {
        //return TheRouter.get().navigation(ICartService.class);//如果只有一个实现，这种方式也可以
    ...
    public static Fragment getCartProductFragment() {

        return getService().getProductFragment() != null ? getService().getProductFragment() : new BlankFragment();
    }
}
